...
% \label{descriptor}
% \todo{definitely discard this text}
...
\begin{description}
    ...
    \item [Block critical device classes, block USB completely] This will reduce the usability of the USB interface. And only a small number of device classes can be used for abuse.
